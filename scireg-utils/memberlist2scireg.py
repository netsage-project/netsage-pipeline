...
# To Do / figure out:
#  - dont do a list of ASN objects for each subnet (and/or make simple fields
...
def convert_to_scireg_format(members):
...
def main():
    ...
    output_list = convert_to_scireg_format(members)
