...
Be sure to check to see if it starts ok. If it does not, look for an error message. If all is ok, the last couple lines should be something about connecting to rabbit and how many pipelines are running.
